...
G4VPhysicalVolume *MyDetectorConstruction::DefineVolumes()
{
    ...
    G4VPhysicalVolume *physElectrode = new G4PVPlacement(0, G4ThreeVector(0, 5*cm, 0), logicElectrode, "physElectrode", logicWorld, false, 0, true);

    G4Tubs *solidGas = new G4Tubs("solidGas", .55*mm, 3.05*mm, 11.8*mm, 0*deg, 360*deg);
    G4LogicalVolume *logicGas = new G4LogicalVolume(solidGas, worldMat, "logicGas");
    G4VPhysicalVolume *physGas = new G4PVPlacement(0, G4ThreeVector(0, 5*cm, 0), logicGas, "physGas", logicWorld, false, 0, true);
    ...
    G4VPhysicalVolume *physGraphite = new G4PVPlacement(0, G4ThreeVector(0, 5*cm, 0), logicGraphite, "physGraphite", logicWorld, false, 0, true);
    ...
    G4VPhysicalVolume *physPMMA = new G4PVPlacement(0, G4ThreeVector(0, 5*cm, 0), logicPMMA, "physPMMA", logicWorld, false, 0, true);


    G4cout << G4endl <<  "--------------------------------------------------" << G4endl << "Active region mass (detector): " << logicGas->GetMass() / kg << " kg" << G4endl << "--------------------------------------------------" << G4endl;
    ...
    logicGas->SetVisAttributes(G4Colour::White());
...
void MyDetectorConstruction::ConstructSDandField()
{
    ...
    SetSensitiveDetector("logicGas", doseDet);
}
