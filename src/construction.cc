...
G4VPhysicalVolume *MyDetectorConstruction::DefineVolumes()
{
    ...
    G4VPhysicalVolume *physElectrode = new G4PVPlacement(0, G4ThreeVector(0, 1*m, 0), logicElectrode, "physElectrode", logicWorld, false, 0, true);
    ...
    G4VPhysicalVolume *physGas = new G4PVPlacement(0, G4ThreeVector(0, 1*m, 0), logicGas, "physGas", logicWorld, false, 0, true);
    ...
    G4VPhysicalVolume *physGraphite = new G4PVPlacement(0, G4ThreeVector(0, 1*m, 0), logicGraphite, "physGraphite", logicWorld, false, 0, true);
    ...
    G4VPhysicalVolume *physPMMA = new G4PVPlacement(0, G4ThreeVector(0, 1*m, 0), logicPMMA, "physPMMA", logicWorld, false, 0, true);
